...
Markdown and Typst files placed in the project's `docs/` directory (configurable via `[docs] root` in `mikon.toml`) are viewable in the "Docs" tab of the dashboard.
