...
- **Document viewer** — Markdown and Typst files placed in `docs/` are viewable in the dashboard.
...
- `typst` CLI (optional, only needed for Typst document rendering)
...
For the full usage guide, SDK reference, CLI options, and API error model, see [USAGE-en.md](USAGE-en.md).
